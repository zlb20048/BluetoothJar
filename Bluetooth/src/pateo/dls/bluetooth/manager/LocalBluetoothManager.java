...
/**
 * LocalBluetoothManager provides an interface between the Settings app
 * and the functionality of the local {@link android.bluetooth.BluetoothAdapter}, specifically
...
public final class LocalBluetoothManager
{
    ...
    private LocalBluetoothManager(BluetoothAdapter adapter)
    {
        mAdapter = adapter;
    }
    ...
    public static synchronized LocalBluetoothManager getInstance()
    {
        if (sInstance == null)
        {
            ...
            if (adapter != null)
            {
                sInstance = new LocalBluetoothManager(adapter);
            }
        }
